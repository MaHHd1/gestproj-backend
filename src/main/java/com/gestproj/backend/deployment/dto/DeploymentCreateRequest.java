...
public record DeploymentCreateRequest(
    ...
    String workflowName, String workflowRunId, String workflowUrl,
    String deploymentTarget, String dockerStatus, String dockerDetails) {
  public DeploymentCreateRequest(String status, String commitHash, String commitMessage, String triggeredBy) {
