...
public class ProjectInvitationActionController {
  ...
  @GetMapping("/{token}")
  public ResponseEntity<ProjectInvitationResponse> getByToken(
  ...
  public ResponseEntity<ProjectInvitationResponse> accept(
      @PathVariable String token, Authentication authentication) {
    return ResponseEntity.ok(projectInvitationService.accept(token, authentication.getName()));
  }

  @PostMapping("/{token}/reject")
  public ResponseEntity<ProjectInvitationResponse> reject(
      @PathVariable String token, Authentication authentication) {
