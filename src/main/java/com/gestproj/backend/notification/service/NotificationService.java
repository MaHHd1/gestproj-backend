...
public class NotificationService {
    ...
    public Notification notify(User user, NotificationType type, String title, String message, Project project, ProjectInvitation invitation, ProjectMember projectMember) {
    ...
    public Notification notifyByEmail(String email, NotificationType type, String title, String message, Project project, ProjectInvitation invitation, ProjectMember projectMember) {
    ...
    public NotificationResponse markRead(Long id, String email) {
        ...
        Notification notification = notificationRepository.findById(id)
                ...
                .orElseThrow(() -> new com.gestproj.backend.common.exception.ResourceNotFoundException("Notification not found"));
    ...
    public void markAllRead(String email) {
        User user = userService.findEntityByEmail(email);
        notificationRepository.findAllByUserAndReadFalseOrderByCreatedAtDesc(user).forEach(notification -> {
            notification.setRead(true);
