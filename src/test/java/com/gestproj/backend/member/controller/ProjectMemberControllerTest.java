...
class ProjectMemberControllerTest {
  ...
  void listShouldReturnMembers() {
    ...
    when(projectMemberService.findProjectMember(project, user))
        .thenReturn(new com.gestproj.backend.member.entity.ProjectMember());
    when(projectMemberService.getProjectMembers(project))
        .thenReturn(
            List.of(
